  ...
  if (orderPlaced) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-20 text-center space-y-6">
        <div className="p-8 sm:p-12 rounded-3xl bg-white border border-[#A7F3D0] shadow-xl space-y-4">
          ...
          <div className="p-4 rounded-xl bg-[#F8FAFC] border border-[#E2E8F0] text-xs text-[#475569] max-w-md mx-auto text-left space-y-2">
            <div className="flex justify-between">
              <span>Customer Name:</span> <strong className="text-[#0F172A]">{customerName}</strong>
            </div>
            <div className="flex justify-between">
              <span>Phone Contact:</span> <strong className="text-[#0F172A]">{phone}</strong>
            </div>
            <div className="flex justify-between">
  ...
  if (cart.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center space-y-6">
        <div className="p-12 rounded-3xl bg-white border border-[#E2E8F0] max-w-lg mx-auto space-y-4 shadow-sm">
          <ShoppingBag className="w-16 h-16 text-[#94A3B8] mx-auto" />
          <h2 className="text-2xl font-bold text-[#0F172A]">Your Shopping Cart is Empty</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-4">
          {cart.map((item) => (
            <div
              key={item.product.id}
              className="p-5 rounded-2xl bg-white border border-[#E2E8F0] shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4"
            >
              <div className="flex items-center gap-4 w-full sm:w-auto">
                <img
                  src={item.product.imageUrl}
                  alt={item.product.name}
                  className="w-20 h-20 rounded-xl object-cover bg-[#F8FAFC] border border-[#E2E8F0]"
                />
                <div>
              ...
              <div className="flex items-center justify-between w-full sm:w-auto gap-6 pt-2 sm:pt-0 border-t sm:border-t-0 border-[#E2E8F0]">
                {/* Quantity adjuster */}
        ...
        <div className="lg:col-span-5">
          <div className="p-6 rounded-3xl bg-white border border-[#E2E8F0] shadow-sm space-y-6">
            <h2 className="text-xl font-bold text-[#0F172A]">Order Checkout & Delivery</h2>
            ...
            <form onSubmit={handlePlaceOrder} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-[#475569]">District *</label>
                  <select
                    value={district}
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-[#475569]">Full Street Address *</label>
                <textarea
                  required
                  rows={2}
              ...
              <div className="space-y-2 pt-2">
                <label className="text-xs font-bold text-[#475569] uppercase">Payment Method</label>
