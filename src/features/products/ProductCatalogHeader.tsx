  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-[#F0F9FF] via-white to-[#F8FAFC] border border-[#BAE6FD] shadow-sm relative overflow-hidden">
        <div className="absolute right-0 top-0 w-64 h-64 bg-[#00BCE1]/5 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none" />
        
        {/* Pill badge: COMPLETE PURIFICATION CATALOG */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#00BCE1] text-white text-xs font-bold shadow-sm">
        ...
        <h1 className="text-2xl sm:text-4xl font-black text-[#0F172A] tracking-tight mt-3">
          All Water Purification <span className="text-[#00BCE1]">Products</span>
        </h1>
        ...
        {typeof totalCount === 'number' && (
          <div className="mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-[#008BAA] bg-sky-100/60 px-3 py-1 rounded-lg">
